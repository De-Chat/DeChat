...
type SendConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>
...
export class Send__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<Send> {
