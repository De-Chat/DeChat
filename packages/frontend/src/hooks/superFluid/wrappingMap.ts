...
const rawWrappingMap: Record<string, string> = {
    '0x15F0Ca26781C3852f8166eD2ebce5D18265cceb7': '0x5D8B4C2554aeB7e86F387B4d6c00Ac33499Ed01f', // DAI -> DAIx
}
...
export const getSuperfluidBaseTokens = () => Object.keys(wrappingMap).map(t => t.toLowerCase())